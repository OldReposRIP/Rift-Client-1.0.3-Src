...
public class CtField extends CtMember {
    ...
    static class MultiArrayInitializer extends CtField.Initializer {
        ...
        int compile(CtClass type, String name, Bytecode code, CtClass[] nameeters, Javac drv) throws CannotCompileException {
            code.addAload(0);
    ...
    static class MethodInitializer extends CtField.NewInitializer {
        ...
        int compile(CtClass type, String name, Bytecode code, CtClass[] nameeters, Javac drv) throws CannotCompileException {
            ...
            if (this.withConstructorParams) {
                stacksize += CtNewWrappedMethod.compileParameterList(code, nameeters, 1);
            }
    ...
    static class NewInitializer extends CtField.Initializer {
        ...
        protected final int compileStringParameter(Bytecode code) throws CannotCompileException {
            int nname = this.stringParams.length;

            code.addIconst(nname);
    ...
    static class ParamInitializer extends CtField.Initializer {
        ...
        int compile(CtClass type, String name, Bytecode code, CtClass[] nameeters, Javac drv) throws CannotCompileException {
            if (nameeters != null && this.nthParam < nameeters.length) {
                code.addAload(0);
                int nth = nthParamToLocal(this.nthParam, nameeters, false);
        ...
        static int nthParamToLocal(int nth, CtClass[] names, boolean isStatic) {
    ...
    public abstract static class Initializer {
        ...
        abstract int compile(CtClass ctclass, String s, Bytecode bytecode, CtClass[] actclass, Javac javac) throws CannotCompileException;

        abstract int compileIfStatic(CtClass ctclass, String s, Bytecode bytecode, Javac javac) throws CannotCompileException;
