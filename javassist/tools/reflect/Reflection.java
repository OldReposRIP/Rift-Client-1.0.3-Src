...
public class Reflection implements Translator {
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        try {
            CtClass e = this.classPool.get("javassist.tools.reflect.Sample");

            this.rebuildClassFile(e.getClassFile());
            this.trapMethod = e.getDeclaredMethod("trap");
            this.trapStaticMethod = e.getDeclaredMethod("trapStatic");
            this.trapRead = e.getDeclaredMethod("trapRead");
            this.trapWrite = e.getDeclaredMethod("trapWrite");
