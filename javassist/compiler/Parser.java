...
public final class Parser implements TokenId {
    ...
    public Stmnt parseStatement(SymbolTable tbl) throws CompileError {
        ...
        if (t == 123) {
            ...
            return t == 320 ? this.parseIf(tbl) : (t == 346 ? this.parseWhile(tbl) : (t == 311 ? this.parseDo(tbl) : (t == 318 ? this.parseFor(tbl) : (t == 343 ? this.parseTry(tbl) : (t == 337 ? this.parseSwitch(tbl) : (t == 338 ? this.parseSynchronized(tbl) : (t == 333 ? this.parseReturn(tbl) : (t == 340 ? this.parseThrow(tbl) : (t == 302 ? this.parseBreak(tbl) : (t == 309 ? this.parseContinue(tbl) : this.parseDeclarationOrExpression(tbl, false)))))))))));
        }
    }
    ...
    private int getOpPrecedence(int c) {
        return 33 <= c && c <= 63 ? Parser.binaryOpPrecedence[c - 33] : (c == 94 ? 7 : (c == 124 ? 8 : (c == 369 ? 9 : (c == 368 ? 10 : (c != 358 && c != 350 ? (c != 357 && c != 359 && c != 323 ? (c != 364 && c != 366 && c != 370 ? 0 : 3) : 4) : 5)))));
    }
