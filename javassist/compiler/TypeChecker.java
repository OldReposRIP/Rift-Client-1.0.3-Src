...
public class TypeChecker extends Visitor implements Opcode, TokenId {
    ...
    private void atVariableAssign(Expr expr, int op, Variable variable, Declarator d, ASTree right) throws CompileError {
        int i = d.getType();
        int j = d.getArrayDim();
    ...
    private Expr atPlusExpr(BinExpr expr) throws CompileError {
        ...
        if (right == null) {
            ...
            if (this.isConstant(expr, 43, left, right)) {
                return null;
            } else if ((type11 != 307 || dim1 != 0 || !"java/lang/String".equals(cname)) && (this.exprType != 307 || this.arrayDim != 0 || !"java/lang/String".equals(this.className))) {
            ...
            if (value == null) {
                ...
                if (!(value instanceof Double) && !(value instanceof Float)) {
                    if (value instanceof Number) {
                        ...
                        return value instanceof Boolean ? new Keyword(((Boolean) value).booleanValue() ? 410 : 411) : null;
                    }
                } else {
    ...
    public void atCallExpr(CallExpr expr) throws CompileError {
        ...
        MemberResolver.Method minfo1 = this.atMethodCallCore(targetClass, mname, args);
            ...
            if (expr instanceof Expr) {
                ...
                if (op == 46) {
                    try {
                        ...
                        return this.fieldAccess2(e, nofieldexception.getField());
                    }
