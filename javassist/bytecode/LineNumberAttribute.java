...
public class LineNumberAttribute extends AttributeInfo {
    ...
    public LineNumberAttribute.Pc toNearPc(int line) {
        ...
        LineNumberAttribute.Pc linenumberattribute_pc = new LineNumberAttribute.Pc();

        linenumberattribute_pc.index = nearPc;
        linenumberattribute_pc.line = line + distance;
        return linenumberattribute_pc;
    }
    ...
    public AttributeInfo copy(ConstPool newCp, Map classnames) {
        ...
        LineNumberAttribute linenumberattribute = new LineNumberAttribute(newCp, dest);
