...
public class TypedBlock extends BasicBlock {
        ...
        if (c == 41) {
            ...
            if (c == 76) {
                ...
                if (arrayDim > 0) {
                    ...
                    ++i;
                    types[n] = new TypeData.ClassName(desc.substring(j, i - 1).replace('/', '.'));
                }
    ...
    public static String getRetType(String desc) {
        ...
        if (i < 0) {
            ...
            return c == 91 ? desc.substring(i + 1) : (c == 76 ? desc.substring(i + 2, desc.length() - 1).replace('/', '.') : "java.lang.Object");
        }
    }
