...
public class MethodInfo {
    ...
    void prune(ConstPool cp) {
        ...
        AttributeInfo nameeterInvisibleAnnotations = this.getAttribute("RuntimeInvisibleParameterAnnotations");

        if (nameeterInvisibleAnnotations != null) {
            nameeterInvisibleAnnotations = nameeterInvisibleAnnotations.copy(cp, (Map) null);
            newAttributes.add(nameeterInvisibleAnnotations);
        }

        AttributeInfo nameeterVisibleAnnotations = this.getAttribute("RuntimeVisibleParameterAnnotations");

        if (nameeterVisibleAnnotations != null) {
            nameeterVisibleAnnotations = nameeterVisibleAnnotations.copy(cp, (Map) null);
            newAttributes.add(nameeterVisibleAnnotations);
        }
