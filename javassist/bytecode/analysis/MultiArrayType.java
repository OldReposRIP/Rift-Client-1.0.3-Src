...
public class MultiArrayType extends Type {
    ...
    public boolean isAssignableTo(Type type) {
        if (eq(type.getCtClass(), Type.OBJECT.getCtClass())) {
            ...
            return typeDims > this.dims ? false : (typeDims < this.dims ? (eq(typeRoot.getCtClass(), Type.OBJECT.getCtClass()) ? true : (eq(typeRoot.getCtClass(), Type.CLONEABLE.getCtClass()) ? true : eq(typeRoot.getCtClass(), Type.SERIALIZABLE.getCtClass()))) : this.component.isAssignableTo(typeRoot));
        }
    }
