...
public class Bytecode extends ByteVector implements Cloneable, Opcode {
    ...
    public void setMaxLocals(boolean isStatic, CtClass[] names, int locals) {
        if (!isStatic) {
            ++locals;
        }
    ...
    public int addLoadParameters(CtClass[] names, int offset) {
        int stacksize = 0;
        ...
        if (names != null) {
            ...
            for (int i = 0; i < n; ++i) {
                stacksize += this.addLoad(stacksize + offset, names[i]);
            }
        }
    ...
    public void addInvokespecial(CtClass clazz, String name, CtClass returnType, CtClass[] nameTypes) {
        String desc = Descriptor.ofMethod(returnType, nameTypes);
    ...
    public void addInvokestatic(CtClass clazz, String name, CtClass returnType, CtClass[] nameTypes) {
        String desc = Descriptor.ofMethod(returnType, nameTypes);
    ...
    public void addInvokevirtual(CtClass clazz, String name, CtClass returnType, CtClass[] nameTypes) {
        String desc = Descriptor.ofMethod(returnType, nameTypes);
    ...
    public void addInvokeinterface(CtClass clazz, String name, CtClass returnType, CtClass[] nameTypes, int count) {
        String desc = Descriptor.ofMethod(returnType, nameTypes);
