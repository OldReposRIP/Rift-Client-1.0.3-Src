...
public abstract class CtBehavior extends CtMember {
    ...
    public void setExceptionTypes(CtClass[] types) throws NotFoundException {
        ...
        if (types != null && types.length != 0) {
            ...
            exceptionsattribute.setExceptions(names);
        } else {
    ...
    static void setBody0(CtClass srcClass, MethodInfo srcInfo, CtClass destClass, MethodInfo destInfo, ClassMap map) throws CannotCompileException {
        ...
        } catch (CodeAttribute.RuntimeCopyException codeattribute_runtimecopyexception) {
            throw new CannotCompileException(codeattribute_runtimecopyexception);
        }
    ...
    public void useCflow(String name) throws CannotCompileException {
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    CtClass e = pool.get("javassist.runtime.Cflow");
                    CtField field = new CtField(e, fname, cc);

                    field.setModifiers(9);
                    cc.addField(field, CtField.Initializer.byNew(e));
                    ...
                    throw new CannotCompileException(notfoundexception1);
                }
            }
        }
    }
    ...
    public void addParameter(CtClass type) throws CannotCompileException {
        ...
        try {
            this.addParameter2(offset + Descriptor.nameSize(desc), type, desc);
        } catch (BadBytecode badbytecode) {
            throw new CannotCompileException(badbytecode);
        }
    ...
    public void insertAfter(String src, boolean asFinally) throws CannotCompileException {
        ...
        if (ca == null) {
            ...
            try {
                ...
                int i = jv.recordReturnType(rtype, true);

                jv.recordLocalVariables(ca, 0);
                int handlerLen = this.insertAfterHandler(asFinally, b, rtype, i, jv, src);
                ...
                while (iterator.hasNext()) {
                    ...
                    if (c == 176 || c == 172 || c == 174 || c == 173 || c == 175 || c == 177) {
                        if (noReturn) {
                            adviceLen = this.insertAfterAdvice(b, jv, src, pool, rtype, i);
    ...
    private int insertAfterAdvice(Bytecode code, Javac jv, String src, ConstPool cp, CtClass rtype, int i) throws CompileError {
        ...
        if (rtype == CtClass.voidType) {
            ...
            code.addStore(i, rtype);
            jv.compileStmnt(src);
            code.addLoad(i, rtype);
